...
| `results/game24-15b-base/` | 正式 1.5B base greedy、best-of-N sweep 评估结果。 |
| `results/game24-sft-15b-curriculum/` | 正式 1.5B SFT warm-up 训练摘要、评估结果、best-of-N sweep 和 loss 曲线。 |
| `results/game24-grpo-15b-curriculum/` | 正式 1.5B SFT+GRPO 训练摘要、评估结果、best-of-N sweep 和 reward/solve 曲线。 |
...
| `results/logs/run_ttc_sweep.log` | 主线 best-of-1/4/8/16 verifier-based test-time compute 远端运行日志。 |
...
| `docs/experiment_ttc_sweep_summary.md` | 主线 best-of-N verifier-based test-time compute sweep 总结。 |
